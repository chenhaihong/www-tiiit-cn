    ...
    <el-main>
      <el-row :gutter="20">
        <el-col :span="24">
          ...
          <el-button @click="() => $refs.form1.clearValidate(['prop_textarea'])">
            清除多行文本输入框的验证
          </el-button>
          ...
          <el-divider />
          <vaf-pro-form ref="form1" :fields="fields1" :hide-submit="false" :hide-reset="false" auto-submit
            @submit="submit" @prop-change="onPropChange" @model-change="onModelChange"
            :formProps="{ inline: false, 'label-width': 180 }" />
        </el-col>
        <el-col :span="24">
          <h2 id="h22" style="margin-bottom: 20px">2. 低频表单组件</h2>
          <vaf-pro-form :fields="fields2" hide-reset @submit="submit" @prop-change="onPropChange"
            @model-change="onModelChange" :formProps="{ inline: false, 'label-width': 180 }" />
        </el-col>
        <el-col :span="24">
          <h2 style="margin-bottom: 20px">2. 任意插槽</h2>
          <vaf-pro-form :fields="fields3" @submit="submit" @prop-change="onPropChange" @model-change="onModelChange"
            :formProps="{ inline: false, 'label-width': 180 }">
