    ...
    <el-main>
      <el-row :gutter="20">
        ...
        <el-col :span="24">
          ...
          <el-button @click="hidePagination = !hidePagination">切换分页器</el-button>
          <el-divider />
          <vaf-pro-table v-loading="loading" ref="vafprotable" :dataFunc="getList" :columns="columns" :buttons="buttons"
            @button-click="clickButton" :defaultData="[]"
            :defaultPagination="{ pageIndex: 2, pageSize: 10, totalSize: 0 }" :hidePagination="hidePagination"
            :tableProps="{ border: true, stripe: true }" :paginationProps="{
              background: false,
              layout: 'total, sizes, prev, pager, next, jumper',
            }" :buttonsColumnProps="{ width: '160px' }" :stopCreatedQuery="false">
